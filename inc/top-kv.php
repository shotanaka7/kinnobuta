...
<div class="top-kv-wrap">
	...
	<div class="top-kv-body">
		...
		<ul class="top-kv-labels">
			...
			<span class="top-kv-label-main"><span class="vertical">創業</span><span class="marker small"><span class="lg num"><?php echo get_established_year(); ?></span>年</span></span>
			</li>
			<li class="top-kv-label">
			<span class="top-kv-label-top">買取実績</span>
			<span class="top-kv-label-main"><span class="marker small"><span class="lg num"><?php echo get_kaitori_jisseki(); ?></span>万点</span></span>
