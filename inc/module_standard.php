...
<section id="hajimete_bnr">
	<div class="pc_only">
	<a href="<?php echo home_url( 'first' ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/common/img/hajimete_bnr_text.svg" alt="簡単なお取引方法はコチラ！"></a>
	</div>
	<div class="sp_only">
	<a href="<?php echo home_url( 'first' ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/common/img/hajimete_bnr_text_sp.png" alt="簡単なお取引方法はコチラ！"></a>
	</div>
</section>
<!-- /簡単なお取引方法はコチラ！ -->
