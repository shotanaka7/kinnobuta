	...
	<div class="in">
		...
		<section id="main_cont">
			...
			<div class="required_wrap">
				<h3 class="title"><span>買取に必要なもの</span></h3>
			...
			<!--流れ-->
			<div id="flow">
			<h2 class="flow_title"><span>店頭買取の流れ</span></h2>
			<div class="flow_list_wrap">
				...
				<li class="detail">
					...
					<div class="textbox">
					<h3 class="title"><span>1</span>ご来店</h3>
				...
				<li class="detail">
					...
					<div class="textbox">
					<h3 class="title"><span>2</span>無料査定</h3>
				...
				<li class="detail">
					...
					<div class="textbox">
					<h3 class="title"><span>3</span>結果のご案内</h3>
				...
				<li class="detail">
					...
					<div class="textbox">
					<h3 class="title"><span>4</span>お支払い</h3>
