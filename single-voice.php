...
<body id="voice">
	...
	<div class="in">
		...
		<section id="main_cont">
			...
			<div class="cont_wrap">
				<div class="qa_box">
				<h2 class="q_text">今回の売却に関しまして他社との比較はございましたでしょうか？</h2>
				<p class="a_text">
					<?php
				...
				<div class="qa_box">
				<h2 class="q_text">買取金額にはご満足いただけましたでしょうか？</h2>
				<p class="a_text">
					<?php
				...
				<div class="qa_box">
				<h2 class="q_text">当社の買取サービスの進行状況にはご満足いただけましたでしょうか？</h2>
				<p class="a_text">
					<?php
				...
				<div class="qa_box">
				<h2 class="q_text">当社のサイト、サービスに於きまして改善したほうが良いと思われる点がございましたら、何なりとご指摘をお願いいたします。</h2>
				<p class="a_text">
					<?php
