...
<body id="top">
	...
	<div class="in">
		...
		<section id="main_cont">
			...
			<h2 class="sec_title"><span>会社概要</span></h2>
			...
			<h2 class="sec_title"><span>プライバシーポリシー</span></h2>
			...
			<div class="policy_box">
				<h3 class="title">1. 個人情報に対する当社の基本姿勢</h3>
			...
			<div class="policy_box">
				<h3 class="title">買取成立後の商品の返品について</h3>
